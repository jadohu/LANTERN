...
class ChameleonModel(ChameleonPreTrainedModel):
    ...
    def _update_causal_mask(
        ...
        if hasattr(self, "tree_mask") and self.tree_mask is not None:
            ...
            tree_mask = tree_mask.repeat(causal_mask.size(0), 1, 1, 1)
...
class ChameleonForConditionalGeneration(ChameleonPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        ...
        self.non_image_tokens = torch.tensor(self.non_image_tokens).to(self.model.device)
        self.post_init()
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        cond_tokens = torch.tensor(cond_tokens).to(self.device)
        uncond_tokens = torch.tensor(uncond_tokens).to(self.device)
        ...
        if hasattr(self.model, "past_key_values"):
            ...
            (
                ...
                current_length_data,
            ) = initialize_past_key_values(self.model, 2)
    ...
    def decode_ids(self, ids):
        return self.tokenizer.decode_image(ids)